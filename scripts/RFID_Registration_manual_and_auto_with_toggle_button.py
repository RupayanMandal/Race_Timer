...
import RFID_and_manual_time_trial as time_trial
...
class race():
    ...
    def add_teams_checkbox(self,add_btn,checkbox_frame):
        ...
        try:
            ...
            choice=tkinter.messagebox.askokcancel(title='COM PORT ERROR', 
        ...
        if race_type=='TIME TRIAL':
            ...
            time_trial.time_trial_race(com_port=comport,number_of_laps=laps,participant_name_list=rfid_list,path=filename)
